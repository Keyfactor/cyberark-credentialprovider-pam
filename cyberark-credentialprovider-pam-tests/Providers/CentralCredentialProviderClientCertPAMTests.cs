...
public class CentralCredentialProviderClientCertPAMTests : BaseCredentialProviderPAMTest
{
    ...
    // The password used to protect the PFX password above. Needs to be able to be used in tests, so it is intentionally simple and not secure.
